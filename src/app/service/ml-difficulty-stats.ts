...
const FEATURE_KEYS: string[] = [
  ...
  "crossAppliedActedUponCellsStdLinearCoef",
  "crossReferenceUnresolvedCellsMaxLast",
  "crossFalsePositiveMeanLinearCoef",
  "crossReferenceResolvableCellsMaxAverage",
  "percentUnresolvedCellsAverage",
  "crossUnusableCellsMeanDelta",
  "requiredCellsStdQuadraticCoef",
  "goalVsTotalAllStdFirst",
  "crossUnusableVsGoalStdStdDev",
  "unusableCellsMaxStdDev",
  "crossRequiredCellsStdQuadraticCoef",
  "crossUnactionableCellsMaxLinearCoef",
  "actionableCellsStdLinearCoef",
  "requiredCellsStdStdDev",
  "unactionableCellsMaxFirst",
  "actionableCellsMaxAverage",
  "crossUnactionableCellsMeanLinearCoef",
